        ...
        if (e.is('select')) {
          ...
          if (t) {
            ...
            ;(n.template = F.extend(
              {},
              u.DEFAULTS.template,
              F.fn.selectpicker.defaults ? F.fn.selectpicker.defaults.template : {},
              e.data().template,
              i.template,
            )),
      ...
      (u.prototype = {
        ...
        createLi: function () {
          ...
          ;(T.options.showTick || T.multiple) &&
            (((e = W.span.cloneNode(!1)).className = T.options.iconBase + ' ' + T.options.tickIcon + ' check-mark'),
            W.a.appendChild(e)),
              ...
              if (!0 === n.hidden || (T.options.hideDisabled && ((v && !f) || m))) {
                ;(i = n.prevHiddenIndex),
                  ...
                  g &&
                    ...
                    (R++, D.push(M(!1, q.DIVIDER, N + 'div')), L.push({ type: 'divider', optID: N }))
              } else {
                if (f && !0 !== n.divider) {
                  ...
                  if (!this.previousElementSibling) {
                    ...
                    var E = (function (e) {
                      ...
                      return (
                        e.labelSubtext &&
                          (((t = W.subtext.cloneNode(!1)).textContent = e.labelSubtext), s.appendChild(t)),
                        B.appendChild(s),
                        B
                      )
                    })({ labelEscaped: k, labelSubtext: $, labelIcon: S })
                    D.push(M(E, 'dropdown-header' + I, N)),
                      L.push({ content: k, subtext: $, type: 'optgroup-label', optID: N }),
                      (P = R - 1)
                  }
                  ...
                  D.push(M(!1, q.DIVIDER)), L.push({ type: 'divider', originalIndex: e, data: n })
                else {
                  var y
        ...
        render: function () {
          ...
          for (var n = 0, o = this.selectpicker.main.elements.length; n < o; n++) {
            ...
            if (
              l &&
              l.selected &&
              (i.push(l), (s.length < 100 && 'count' !== e.options.selectedTextFormat) || 1 === i.length)
            ) {
              if (
                e.options.hideDisabled &&
                (l.disabled || ('OPTGROUP' === l.parentNode.tagName && l.parentNode.disabled))
              )
                return
              var r,
                a,
          ...
          if (
            (50 < i.length && (h += '...'), this.multiple && -1 !== this.options.selectedTextFormat.indexOf('count'))
          ) {
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !this.sizeInfo)) {
            ...
            var t = document.createElement('div'),
              ...
              d =
                this.options.header && 0 < this.$menu.find('.' + q.POPOVERHEADER).length
            ...
            var v,
              ...
              O = {
                vert:
                  C.vert + z(S ? S.marginTop : y.css('marginTop')) + z(S ? S.marginBottom : y.css('marginBottom')) + 2,
                horiz:
                  C.horiz + z(S ? S.marginLeft : y.css('marginLeft')) + z(S ? S.marginRight : y.css('marginRight')) + 2,
              }
          ...
          var s,
            ...
            e = function (e) {
              var t = {},
                i =
                  l.options.display ||
                  (!!F.fn.dropdown.Constructor.Default && F.fn.dropdown.Constructor.Default.display)
              l.$bsContainer
        ...
        setSelected: function (e, t, i, s) {
          ...
          i || (i = this.selectpicker.main.map.newIndex[e]),
            ...
            l &&
              (l.classList.toggle('selected', t), l.classList.toggle('active', a), l.setAttribute('aria-selected', t)),
            a ||
              (!r &&
                t &&
        ...
        checkDisabled: function () {
          ...
          this.isDisabled()
            ? (this.$newElement.addClass(q.DISABLED),
              this.$button.addClass(q.DISABLED).attr('tabindex', -1).attr('aria-disabled', !0))
          ...
          t.data('spaceSelect', !1),
            ...
            this.$menuInner.on('click', 'li a', function (e, t) {
              var i = F(this),
                ...
                r = !0
              if (
                (S.multiple && 1 !== S.options.maxOptions && e.stopPropagation(),
                e.preventDefault(),
                    ...
                    if ((u && m) || (f && v))
                      if (u && 1 == u) {
                        ...
                        I[2] &&
                          ...
                          u &&
                            m &&
                            ($.append(F('<div>' + x + '</div>')), (r = !1), S.$element.trigger('maxReached' + L)),
                          f &&
                            v &&
                            ($.append(F('<div>' + k + '</div>')), (r = !1), S.$element.trigger('maxReachedGrp' + L)),
                          setTimeout(function () {
                            S.setSelected(n, !1)
                          }, 10),
                ...
                !S.multiple || (S.multiple && 1 === S.options.maxOptions)
                  ...
                  r &&
                    ((o != E(S.$element[0]) && S.multiple) || (l != S.$element.prop('selectedIndex') && !S.multiple)) &&
                    ((y = [n, c.prop('selected'), o]), S.$element.triggerNative('change'))
              }
            }),
            this.$menu.on(
              'click',
              'li.' + q.DISABLED + ' a, .' + q.POPOVERHEADER + ', .' + q.POPOVERHEADER + ' :not(.close)',
              function (e) {
        ...
        keydown: function (e) {
          ...
          if (
            ...
            if (!c.length) return
            void 0 ===
              (t = !0 === f ? c.index(c.filter('.active')) : a.selectpicker.current.map.newIndex[a.activeIndex]) &&
              (t = -1),
              -1 !== t &&
              ...
              e.which === H
                ? (-1 !== t && t--,
                  ...
                  a.selectpicker.view.canHighlight[t + m] ||
                    (-1 === (t = a.selectpicker.view.canHighlight.slice(0, t + m).lastIndexOf(!0) - m) &&
                      (t = c.length - 1)))
                : (e.which === A || h) &&
            ...
            if (w.length) {
              ...
              c.removeClass('active').find('a').removeClass('active'),
                ...
                0 < u - (n = a.selectpicker.current.data[g]).position
                  ...
                  : ((o = n.position - a.sizeInfo.menuInnerHeight), (d = n.position > u + a.sizeInfo.menuInnerHeight)),
          ...
          i &&
            ...
            (a.options.liveSearch && e.which === T) ||
              ...
              l.focus(),
              a.options.liveSearch || (e.preventDefault(), F(document).data('spaceSelect', !0))))
        },
        mobile: function () {
