...
!(function (a) {
  ...
  function Q(b, d) {
      ...
      return (
        ...
        d.forEach(function (a, e) {
          ...
          if (('steps' === c && (g = M.xNumSteps[e]), g || (g = u - t), t !== !1 && void 0 !== u))
            for (h = t; u >= h; h += g) {
              for (m = M.toStepping(h), n = m - k, q = n / b, r = Math.round(q), s = n / r, l = 1; r >= l; l += 1)
    ...
    function n(a, b, c) {
      ...
      function g(a, d) {
        M.direction && (a = 100 - a),
          ...
          d[1] && (i.innerHTML += '<div ' + f(a, 'noUi-value', d) + '>' + c.to(d[0]) + '</div>')
      }
    ...
    function v(a, b) {
      ...
      if (1 === b.handles.length && (j(b.handles[0].children[0], T[15]), b.handles[0].hasAttribute('disabled')))
        return !1
      a.stopPropagation()
    ...
    function w(a) {
      ...
      return (
        ...
        H[b].hasAttribute('disabled')
          ? !1
          : (y(H[b], e), q('slide', b), q('set', b), q('change', b), void (d.events.snap && v(a, { handles: [H[h]] })))
      )
    }
    function x(a) {
      var b, c
      ...
      for (d.limit && (a += 1), c = 0; a > c; c += 1)
        (e = c % 2),
          ...
          null !== f &&
            ...
            (f = d.format.from(f)),
            (f === !1 || isNaN(f) || y(H[e], M.toStepping(f), c === 3 - d.dir) === !1) && q('update', e))
    }
    function A(a) {
      var b,
        c,
