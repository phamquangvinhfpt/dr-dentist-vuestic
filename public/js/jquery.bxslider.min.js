    ...
    if (!a(e).data('bxSlider')) {
      var h = function () {
          a(e).data('bxSlider') ||
            ...
            (d.minThreshold =
              d.settings.minSlides * d.settings.slideWidth + (d.settings.minSlides - 1) * d.settings.slideMargin),
            (d.maxThreshold =
              ...
              (function () {
                for (
                  ...
                  if (void 0 !== a.style[b[c]])
                    return (
                      (d.cssPrefix = b[c].replace('Perspective', '').toLowerCase()),
        ...
        j = function () {
          ...
          e.wrap('<div class="' + d.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'),
            ...
            'fade' === d.settings.mode &&
              (d.children.css({ position: 'absolute', zIndex: 0, display: 'none' }),
            ...
            d.settings.ticker
              ...
              : (d.settings.controls && w(),
                ...
                d.settings.pager && v(),
                (d.settings.controls || d.settings.autoControls || d.settings.pager) &&
          ...
          return (
            ...
            'border-box' === d.viewport.css('box-sizing')
              ...
              : 'padding-box' === d.viewport.css('box-sizing') &&
                (b += parseFloat(d.viewport.css('padding-top')) + parseFloat(d.viewport.css('padding-bottom'))),
            b
          )
        },
        n = function () {
              ...
              : d.settings.shrinkItems &&
                (a = Math.floor(
                  (b + d.settings.slideMargin) /
                    Math.ceil((b + d.settings.slideMargin) / (a + d.settings.slideMargin)) -
        ...
        s = function () {
          ...
          d.children.length > d.settings.maxSlides && d.active.last && !d.settings.infiniteLoop
            ? 'horizontal' === d.settings.mode
              ? ((b = d.children.last()),
                (a = b.position()),
                t(-(a.left - (d.viewport.width() - b.outerWidth())), 'reset', 0))
              : 'vertical' === d.settings.mode &&
        ...
        t = function (b, c, f, g) {
          ...
          d.usingCSS
            ? ((i =
                'vertical' === d.settings.mode ? 'translate3d(0, ' + b + 'px, 0)' : 'translate3d(' + b + 'px, 0, 0)'),
        ...
        x = function () {
          ;(d.controls.start = a(
            '<div class="bx-controls-auto-item"><a class="bx-start" href="">' + d.settings.startText + '</a></div>',
          )),
            (d.controls.stop = a(
              '<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + d.settings.stopText + '</a></div>',
            )),
          ...
          b.preventDefault(),
            d.controls.el.hasClass('disabled') ||
              ...
              void 0 !== c.attr('data-slide-index') &&
                ((f = parseInt(c.attr('data-slide-index'))), f !== d.active.index && e.goToSlide(f)))
        },
        E = function (b) {
          var c = d.children.length
          return 'short' === d.settings.pagerType
            ? (d.settings.maxSlides > 1 && (c = Math.ceil(d.children.length / d.settings.maxSlides)),
          ...
          if ((d.controls.el.addClass('disabled'), d.working)) a.preventDefault(), d.controls.el.removeClass('disabled')
            ...
            ;(d.touch.start.x = c[0].pageX),
              ...
              d.viewport.get(0).setPointerCapture &&
                ((d.pointerId = b.pointerId), d.viewport.get(0).setPointerCapture(d.pointerId)),
        ...
        Q = function (a) {
          ...
          3 * e > f && d.settings.preventDefaultSwipeX
            ...
            'fade' !== d.settings.mode &&
              ...
              ('horizontal' === d.settings.mode
                ? ((h = c[0].pageX - d.touch.start.x), (g = d.touch.originalPos.left + h))
                : ((h = c[0].pageY - d.touch.start.y), (g = d.touch.originalPos.top + h)),
              t(g, 'reset', 0))
        },
        R = function (a) {
            ...
            'fade' === d.settings.mode
              ? ((g = Math.abs(d.touch.start.x - d.touch.end.x)),
                g >= d.settings.swipeThreshold &&
                  (d.touch.start.x > d.touch.end.x ? e.goToNextSlide() : e.goToPrevSlide(), e.stopAuto()))
              : ('horizontal' === d.settings.mode
                  ? ((g = d.touch.end.x - d.touch.start.x), (f = d.touch.originalPos.left))
                  : ((g = d.touch.end.y - d.touch.start.y), (f = d.touch.originalPos.top)),
          ...
          if (d.initialized)
            if (d.working) window.setTimeout(S, 10)
              ...
              var c = a(window).width(),
                h = a(window).height()
              ;(f !== c || g !== h) &&
                ((f = c), (g = h), e.redrawSlider(), d.settings.onSliderResize.call(e, d.active.index))
            }
        },
        T = function (a) {
          var b = p()
          d.settings.ariaHidden &&
            !d.settings.ticker &&
            (d.children.attr('aria-hidden', 'true'), d.children.slice(a, a + b).attr('aria-hidden', 'false'))
        },
        U = function (a) {
          return 0 > a
            ? d.settings.infiniteLoop
      ...
      return (
            ...
            'next' === c
              ...
              'fade' === d.settings.mode
                ? (d.settings.adaptiveHeight &&
                    d.viewport.height() !== m() &&
                    d.viewport.animate({ height: m() }, d.settings.adaptiveHeightSpeed),
                ...
                : (d.settings.adaptiveHeight &&
                  ...
                  'undefined' != typeof l
                    ? ((h = 'horizontal' === d.settings.mode ? -(l.left - k) : -l.top), t(h, 'slide', d.settings.speed))
                    : (d.working = !1)),
        ...
        (e.stopAuto = function (a) {
          d.interval &&
            (clearInterval(d.interval), (d.interval = null), d.settings.autoControls && a !== !0 && G('start'))
        }),
